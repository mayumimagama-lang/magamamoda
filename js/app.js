...
const App = {
  ...
  renderPage() {
    ...
    switch (this.currentPage) {
      ...
      case 'resumendia':      html = ResumenDiaModule.render(); break;
      ...
      case 'modoevento':      html = ModoEventoModule.render(); break;
      case 'caja':            html = CajaModule.render(); break;
      case 'reportes':        html = ReportesModule.render(); break;
      case 'administracion':  html = AdministracionModule.render(); break;
      case 'configuracion':   html = ConfiguracionModule.render(); break;
      ...
      case 'tickets':         html = TicketsModule.render(); break;
