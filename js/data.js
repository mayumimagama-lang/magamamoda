...
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyFv958zqcuyg7PksAykEOi0pLEbRMbacNrNI8a7H_o3AkmPtwOYwJ4oX-68o2T_lY4/exec';
...
const SheetsSync = {
  ...
  async cargarProductos() {
    try {
      const res  = await fetch(SCRIPT_URL + '?accion=listar', { redirect: 'follow' });
  ...
  async cargarVentas() {
    try {
      const res  = await fetch(SCRIPT_URL + '?accion=listarVentas', { redirect: 'follow' });
      const json = await res.json();
